...
result = PreprocessingPipeline().run(
    current_path="backend/data/current/sample_70_rgb.png",
    historical_dir="backend/data/historical/",
    cloud_mask_path="backend/data/sample_70_mask.png",
    current_date=date(2023, 6, 15),
    sample_id="real_test_70",
)
...
cv2.imwrite("outputs/sample_70_final.png", output["final_image"])
cv2.imwrite("outputs/sample_70_heatmap.png", output["heatmap"])

print("\n=== Integration Metrics (sample_70) ===")
